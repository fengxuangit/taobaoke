...
{if $goods.status >9}<span style="font-size:18px;color:#F00;">当前状态: {$goods.status_text2}</span>{/if}
...
({$goods.check_status})
{if $goods.check !=1}
      <span  style="color:#F00;">{$goods.check_msg}</span>
{/if}
</li>
...
<!--{/foreach}-->
 ...
 <input class="radio" type="radio" name="postdb[shop_type]" value="2" {if $goods.shop_type==2}checked="checked"{/if}>
      ...
      <li class="uc_zlli1">
        <label>联系人：</label>
         <input class="uinfo uc_zlli1text text" name="postdb[name]"  type="text" value="{$goods.name}">
      </li>
        <li class="uc_zlli1">
        <label>联系电话：</label>
         <input class="uinfo uc_zlli1text text" name="postdb[phone]"  type="text" value="{$goods.phone}">

      </li>

       <li class="uc_zlli1">
        <label>联系qq：</label>
         <input class="uinfo uc_zlli1text text" name="postdb[qq]"  type="text" value="{$goods.qq}">
      </li>
