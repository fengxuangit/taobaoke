...
{/foreach}
          ...
          <td class="vtop tips2">当前资讯所属分类</td>
        </tr>
 ...
 <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="td_l">列表图片类型:</td>
          <td class="vtop rowform">
          
 <input class="radio  check_radio2" type="radio" name="postdb[image_type]" value="2"  {if $goods.image_type=="2"} checked="checked"{/if}>
 &nbsp;视频

<input class="radio check_radio2" type="radio" name="postdb[image_type]" value="1" {if $goods.image_type =='1'} checked="checked"{/if}>

 &nbsp;大图
 <input class="radio  check_radio2" type="radio" name="postdb[image_type]" value="0"  {if $goods.image_type=="0"} checked="checked"{/if}>
 &nbsp;小图
...
<input type="file" name="file" class="J_TCajaUploadImg upload_file_btn" data-url="/upload.php" />
 ...
 <tr class="noborder">
          <td class="td_l">视频地址:</td>
          <td class="vtop rowform"><input name="postdb[vedio]" value="{$goods.vedio}" type="text" class="txt"></td>
          <td class="vtop tips2">视频链接地址</td>
  </tr>
